    ...
    <section className='about section' id="about">
      ...
      <div className="about_container container grid">
        ...
        <div className="about_data">
          <Info/>
          <p className="about_description"> I am a dynamic web developer with a proven track record in both front-end and back-end technologies, including ReactJS, Node.js, and MongoDB. With hands-on experience in optimizing performance, improving UI/UX, and collaborating with cross-functional teams, excels in delivering high-quality, scalable solutions under tight deadlines. Take look</p>
